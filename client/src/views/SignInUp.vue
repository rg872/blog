        ...
        <div class="col-md-6" id="loginCol">
          <h1>Log In</h1>
              ...
              <div class="d-flex flex-sm-column">
                ...
                <button style=" width:fit-content; margin-top:5%;" class="btn btn-success" v-on:click="toAdmin">Are you an admin ?</button>
              </div>
      ...
      login: function(){
        ...
        .then((res)=>{
          ...
          if(res.data.role !== 'user'){
            alert('You are an Admin, please sign in using the admin login page')
          }else{
            localStorage.setItem('token',res.data.token)
            this.$router.push('')
          }  
